...
create_clock -period 100 -name "SCAN_CLK" [get_ports scan_clk]
...
set_clock_group -asynchronous -group [get_clocks SCAN_CLK]
...
set_input_delay 20 -clock SCAN_CLK [get_ports {SI SE}]
set_output_delay 20 -clock SCAN_CLK [get_ports SO]
